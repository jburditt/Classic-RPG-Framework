    ...
    public class Dialog
    {
        ...
        public void Draw(SpriteBatch spriteBatch, Rectangle targetRect, int index)
        {
            ...
            if (targetRect.Width % chipsize != 0)
                spriteBatch.Draw(dialog, new Rectangle(targetRect.X + targetRect.Width - chipsize - targetRect.Width % chipsize, targetRect.Y, targetRect.Width % chipsize, chipsize), mod, Color.White * 0.5f);
            ...
            for (var j = 1; j < targetRect.Height / chipsize - 1; j++)
            {
                ...
                if (targetRect.Width % chipsize != 0)
                    spriteBatch.Draw(dialog, new Rectangle(targetRect.X + targetRect.Width - chipsize - targetRect.Width % chipsize, targetRect.Y + j * chipsize, targetRect.Width % chipsize, chipsize), mod, Color.White * 0.5f);
            }
            ...
            if (targetRect.Width % chipsize != 0)
                spriteBatch.Draw(dialog, new Rectangle(targetRect.X + targetRect.Width - chipsize - targetRect.Width % chipsize, targetRect.Y + targetRect.Height - chipsize, targetRect.Width % chipsize, chipsize), mod, Color.White * 0.5f);
